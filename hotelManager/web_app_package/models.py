...
#         db.session.commit()
#         kor1 = KindOfRoom(name="Normal", unit_price=100)
#         kor2 = KindOfRoom(name="Vip 1", unit_price=200)
#         kor3 = KindOfRoom(name="Vip 2", unit_price=300)
...
#         e3 = Employee(name='ONLINE', username="Online",
#                       password=str(hashlib.md5('123456'.encode('utf-8')).hexdigest()), user_role=UserRoleEnum.SYSTEM)
...
#         db.session.commit()
        ...
        # rr4 = Room(name="A3", kind_of_room_id=2)
        # rr5 = Room(name="B0", kind_of_room_id=2)
        # rr6 = Room(name="B1", kind_of_room_id=3)
